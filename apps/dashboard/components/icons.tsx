...
function Icon({ size = 18, ...props }: IconProps): React.JSX.Element {
  return (
    <svg
...
export function IconProjects(props: IconProps): React.JSX.Element {
  return (
    <Icon {...props}>
...
export function IconOrganizations(props: IconProps): React.JSX.Element {
  return (
    <Icon {...props}>
...
export function IconBilling(props: IconProps): React.JSX.Element {
  return (
    <Icon {...props}>
...
export function IconAIBuilder(props: IconProps): React.JSX.Element {
  return (
    <Icon {...props}>
...
export function IconCLI(props: IconProps): React.JSX.Element {
  return (
    <Icon {...props}>
...
export function IconStorage(props: IconProps): React.JSX.Element {
  return (
    <Icon {...props}>
      <path d="M22 12H2" />
      <path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z" />
      <line x1="6" y1="16" x2="6.01" y2="16" strokeWidth={2.4} />
      <line x1="10" y1="16" x2="10.01" y2="16" strokeWidth={2.4} />
    </Icon>
  );
}

export function IconFunctions(props: IconProps): React.JSX.Element {
  return (
    <Icon {...props}>
...
export function IconLogs(props: IconProps): React.JSX.Element {
  return (
    <Icon {...props}>
...
export function IconUsage(props: IconProps): React.JSX.Element {
  return (
    <Icon {...props}>
...
export function IconAuth(props: IconProps): React.JSX.Element {
  return (
    <Icon {...props}>
...
export function IconSQL(props: IconProps): React.JSX.Element {
  return (
    <Icon {...props}>
      <polyline points="4 17 10 11 4 5" />
      <line x1="12" y1="19" x2="20" y2="19" />
...
export function IconRealtime(props: IconProps): React.JSX.Element {
  return (
    <Icon {...props}>
...
export function IconCloud(props: IconProps): React.JSX.Element {
  return (
    <Icon {...props}>
...
/** Map icon names to components for command palette / nav. */
