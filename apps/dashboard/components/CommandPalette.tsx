...
export function CommandPalette({ open, onClose }: { open: boolean; onClose: () => void }): React.JSX.Element | null {
  ...
  const commands = useMemo<Command[]>(() => {
    ...
    list.push(
      ...
      { id: 'go-capabilities', group: 'Go to', label: 'Capability registry (internal)', icon: <IconOverview size={16} />, keywords: 'capability registry internal tracking coverage', run: go('/capabilities') },
    );
    return list;
