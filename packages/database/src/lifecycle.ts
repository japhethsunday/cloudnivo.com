...
export const DB_AUDIT_EVENTS = [
  ...
  'data.imported',
  'ai.diagnosed',
  'automation.queue.created',
  'automation.queue.deleted',
  'automation.message.published',
  'automation.schedule.created',
  'automation.schedule.deleted',
  'automation.schedule.triggered',
  'automation.schedule_invoked',
  'automation.webhook.created',
  'automation.webhook.deleted',
  'automation.webhook.rotated',
